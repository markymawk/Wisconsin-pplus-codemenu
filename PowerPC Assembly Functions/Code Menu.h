...
//static const int SCALE_MODIFIER_LOC = BIG_HEAD_TOGGLE_LOC + 4; //4
//static const int DRAW_SETTINGS_BUFFER_LOC = SCALE_MODIFIER_LOC + 4; //0x200

static const int DRAW_SETTINGS_BUFFER_LOC = BIG_HEAD_TOGGLE_LOC + 4; //0x200

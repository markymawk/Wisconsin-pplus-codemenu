...
extern int RESULTS_MUSIC_INDEX;
...
//static const int RESULTS_MUSIC_INDEX_LOC = SHIELD_COLOR_P4_INDEX_LOC + 4; //4
//static const int DRAW_SETTINGS_BUFFER_LOC = RESULTS_MUSIC_INDEX_LOC + 4; //0x200

static const int DRAW_SETTINGS_BUFFER_LOC = SHIELD_COLOR_P4_INDEX_LOC + 4; //0x200

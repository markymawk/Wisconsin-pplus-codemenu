...
static const int RANDOM_TEAMS_LOC = THEME_LOC + 4;
static const int LEDGEGRAB_LIMIT_LOC = RANDOM_TEAMS_LOC + 4;
static const int SCREEN_SHAKE_LOC = LEDGEGRAB_LIMIT_LOC + 4;
static const int DI_RANGE_LOC = SCREEN_SHAKE_LOC + 4;
static const int HITFALLING_LOC = DI_RANGE_LOC + 4;
static const int CROUCH_KNOCKBACK_LOC = HITFALLING_LOC + 4;
static const int GRROUNDED_ASDI_LOC = CROUCH_KNOCKBACK_LOC + 4;
static const int SHIELD_DECAY_LOC = GRROUNDED_ASDI_LOC + 4;
static const int SHIELD_REGEN_LOC = SHIELD_DECAY_LOC + 4;
static const int GRABS_TRADE_LOC = SHIELD_REGEN_LOC + 4;
static const int BALLOON_STOCK_LOC = GRABS_TRADE_LOC + 4;
static const int UNIVERSAL_WALLJUMP_LOC = BALLOON_STOCK_LOC + 4;
static const int SOLO_COUNTDOWN_LOC = UNIVERSAL_WALLJUMP_LOC + 4;
static const int SHIELD_COLOR_P1_LOC = SOLO_COUNTDOWN_LOC + 4;
static const int SHIELD_COLOR_P2_LOC = SHIELD_COLOR_P1_LOC + 4;
static const int SHIELD_COLOR_P3_LOC = SHIELD_COLOR_P2_LOC + 4;
static const int SHIELD_COLOR_P4_LOC = SHIELD_COLOR_P3_LOC + 4;
static const int ORDERED_STAGE_LOC = SHIELD_COLOR_P4_LOC + 4;

static const int P1_HIDDEN_COSTUME_LOC = ORDERED_STAGE_LOC + 4;
static const int P2_HIDDEN_COSTUME_LOC = P1_HIDDEN_COSTUME_LOC + 4;

static const int DRAW_SETTINGS_BUFFER_LOC = P2_HIDDEN_COSTUME_LOC + 4; //0x200
/*
...
private:
	constexpr std::array<int, __COLOR_COUNT> getArray()
	{
		...
		result[COLORS::COLOR_WHITE]         = 0xA7ACAFFF;
		result[COLORS::COLOR_YELLOW]        = 0xFFFF2DFF;
		result[COLORS::COLOR_TEAL]          = 0x66A4ADFF; //USED by changed & unselected line
		result[COLORS::COLOR_BLUE]          = 0xFFD42BFF; //USED by changed & selected line, not sure where
		result[COLORS::COLOR_GREEN]         = 0x41C145FF;

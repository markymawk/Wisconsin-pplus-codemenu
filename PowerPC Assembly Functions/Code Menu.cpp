...
void CodeMenu()
{
	...
	SpecialSettings.push_back(new Comment(""));
	SpecialSettings.push_back(new Selection("Timeout LGL", { "OFF", "35", "40", "45", "50", "55", "60" }, 3, LEDGEGRAB_LIMIT_INDEX));
...
void ControlCodeMenu()
{
	...
	if (SHIELD_COLOR_P1_INDEX != -1) {
		...
		int PURPLE_SHIELD_COLORS[3] = { 0x6300FF00, 0x7700EF00, 0x8F0EEA00 };

...
#if DOLPHIN_BUILD
	MainLines.push_back(new Comment("WI Netplay Code Menu (P+ 2.31)", &MENU_TITLE_CHECK_LOCATION));
#else
	MainLines.push_back(new Comment("WI Code Menu (P+ 2.31)", &MENU_TITLE_CHECK_LOCATION));
#endif

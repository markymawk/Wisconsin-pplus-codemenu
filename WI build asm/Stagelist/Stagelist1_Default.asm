...
TABLE_1:
	byte[14] |
0x20, 0x15, 0x18, 0x04, 0x01, 0x23, 0x0A, | 	# Story, Wario, FoD, Metal, FD, DL, Metroid Lab
0x19, 0x1C, 0x1A, 0x00, 0x28, 0x02, 0x21		# Alt Siege, GHZ, SV, BF, PS2, Delfino, Golden Temple

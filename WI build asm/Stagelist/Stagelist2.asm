...
* 0417BE70 00021000 # Legal stages: CS, SV, BF, PS2, DS
* 0417BE74 17000015 # GHZ, FoD, MC, DL
* E0000000 80008000
* 42000000 80000000
...
TABLE_1:
    byte[11] |
0x1C, 0x18, 0x04, 0x23,       | # GHZ, FoD, Metal, Dream Land
0x19, 0x1A, 0x00, 0x28, 0x02, | # Siege (alt), SV, BF, PS2, Delfino
0x2B, 0x2B                      # Training, Training
